...
/**
 * Provides the local service utility for RemoteForm. This utility wraps
 * {@link com.remote.application.service.impl.RemoteFormLocalServiceImpl} and is the
 ...
 * @generated
 */
public class RemoteFormLocalServiceUtil {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to {@link com.remote.application.service.impl.RemoteFormLocalServiceImpl} and rerun ServiceBuilder to regenerate this class.
	 */
	...
	*/
	public static com.remote.application.model.RemoteForm addRemoteForm(
		com.remote.application.model.RemoteForm remoteForm)
		throws com.liferay.portal.kernel.exception.SystemException {
		return getService().addRemoteForm(remoteForm);
	}
	...
	*/
	public static com.remote.application.model.RemoteForm createRemoteForm(
		long remoteFormId) {
		return getService().createRemoteForm(remoteFormId);
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public static com.remote.application.model.RemoteForm deleteRemoteForm(
		long remoteFormId)
		throws com.liferay.portal.kernel.exception.PortalException,
			com.liferay.portal.kernel.exception.SystemException {
		return getService().deleteRemoteForm(remoteFormId);
	}
	...
	*/
	public static com.remote.application.model.RemoteForm deleteRemoteForm(
		com.remote.application.model.RemoteForm remoteForm)
		throws com.liferay.portal.kernel.exception.SystemException {
		return getService().deleteRemoteForm(remoteForm);
	}
	...
	*/
	...
	public static com.remote.application.model.RemoteForm fetchRemoteForm(
		long remoteFormId)
		throws com.liferay.portal.kernel.exception.SystemException {
		return getService().fetchRemoteForm(remoteFormId);
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public static com.remote.application.model.RemoteForm getRemoteForm(
		long remoteFormId)
		throws com.liferay.portal.kernel.exception.PortalException,
			com.liferay.portal.kernel.exception.SystemException {
		return getService().getRemoteForm(remoteFormId);
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public static java.util.List<com.remote.application.model.RemoteForm> getRemoteForms(
		int start, int end)
		throws com.liferay.portal.kernel.exception.SystemException {
		return getService().getRemoteForms(start, end);
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public static int getRemoteFormsCount()
		throws com.liferay.portal.kernel.exception.SystemException {
		return getService().getRemoteFormsCount();
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public static com.remote.application.model.RemoteForm updateRemoteForm(
		com.remote.application.model.RemoteForm remoteForm)
		throws com.liferay.portal.kernel.exception.SystemException {
		return getService().updateRemoteForm(remoteForm);
	}
	...
	*/
	...
	public static java.util.List<java.lang.String> fetchCycles(
		...
		throws com.liferay.portal.kernel.exception.SystemException {
		return getService().fetchCycles(applicant, status);
	}

	public static com.remote.application.model.RemoteForm upsertRemoteForm(
		...
		throws com.liferay.portal.kernel.exception.PortalException,
			com.liferay.portal.kernel.exception.SystemException {
		return getService()
				   .upsertRemoteForm(remoteFormId, creator, applicant,
			remoteDate, remark, extPayload, context);
	}
	...
	public static com.remote.application.model.RemoteForm upsertRemoteForm(
		...
		return getService()
				   .upsertRemoteForm(remoteFormId, creator, applicant,
			remoteDate, endDateTime, remark, extPayload, dayTab, context);
	}

	public static void removeRemoteForm(long remoteFormId)
		throws com.liferay.portal.kernel.exception.PortalException,
			com.liferay.portal.kernel.exception.SystemException {
		getService().removeRemoteForm(remoteFormId);
	}

	public static com.remote.application.model.RemoteForm updateStatus(
		long userId, long remoteFormId, int status,
		com.liferay.portal.service.ServiceContext context)
		throws com.liferay.portal.kernel.exception.PortalException,
			com.liferay.portal.kernel.exception.SystemException {
		return getService().updateStatus(userId, remoteFormId, status, context);
	}
	...
	public static java.util.List<com.remote.application.model.RemoteForm> searchForStatistics(
		...
		throws com.liferay.portal.kernel.exception.SystemException {
		return getService()
				   .searchForStatistics(applicant, statuses, startDateTime,
			endDateTime);
	}
	...
	public static java.util.List<com.remote.application.model.RemoteForm> checkOverlappingTimes(
		...
		throws com.liferay.portal.kernel.exception.SystemException {
		return getService().checkOverlappingTimes(applicant, startDateTime);
	}

	public static java.lang.String getRemotePeriodDisplay(
		java.util.Date start, java.util.Date end, java.util.TimeZone timeZone) {
		return getService().getRemotePeriodDisplay(start, end, timeZone);
	}
	...
	public static RemoteFormLocalService getService() {
		if (_service == null) {
			InvokableLocalService invokableLocalService = (InvokableLocalService)PortletBeanLocatorUtil.locate(ClpSerializer.getServletContextName(),
					RemoteFormLocalService.class.getName());

			if (invokableLocalService instanceof RemoteFormLocalService) {
				_service = (RemoteFormLocalService)invokableLocalService;
			}
			else {
				_service = new RemoteFormLocalServiceClp(invokableLocalService);
			}

			ReferenceRegistry.registerReference(RemoteFormLocalServiceUtil.class,
				"_service");
		}
	 ...
	 */
	public void setService(RemoteFormLocalService service) {
	}

	private static RemoteFormLocalService _service;
}